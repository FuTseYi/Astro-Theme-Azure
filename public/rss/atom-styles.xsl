  ...
  <xsl:template match="/atom:feed">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      ...
      <body>
        ...
        <div class="belonging">This is a RSS Feed generated by <a href="{atom:link[@rel='alternate']/@href}"
            target="_blank">
            <xsl:value-of select="atom:title" /></a>. RSS readers can use the URL in the address bar. </div>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>