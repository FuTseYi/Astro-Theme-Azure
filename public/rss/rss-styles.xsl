  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <div class="belonging">This is a RSS Feed generated by <a href="{/rss/channel/link}"
            target="_blank"><xsl:value-of select="/rss/channel/title" /></a>. RSS readers can use the URL in the address bar.</div>
      </body>
    </html>
  </xsl:template>
</xsl:stylesheet>