---
title: 'Azure: Markdown enhanced syntax'
...
<!-- ⚠︝ At least one line must separate two image syntaxes (![]()), or won't work. -->
...
> [!warning]
>
> Setting an image's `width` attribute directly may cause blurriness. [Learn more](https://github.com/FuTseYi/Azure/discussions/17)
...
```md title=':::image-a.md'
:::image-a{href="https://github.com/FuTseYi/Azure"}
![OG image](assets/cover.png)
:::

:::image-a{href="https://github.com/FuTseYi/Azure" style="display:block" .custom-class}
...
**Example 1**: `:link[FuTseYi]{#@FuTseYi}` links to the GitHub profile of the project maintainer, :link[FuTseYi]{#@FuTseYi}.

**Example 2**: `:link[Vite]{id=@vitejs}` links to the GitHub profile of the :link[Vite]{id=@vitejs} organization.

**Example 3**: `:link{#@FuTseYi tab=repositories}` links directly to the repositories tab of the GitHub user, like :link{#@FuTseYi tab=repositories}. For GitHub users, valid `tab` options: `'repositories','projects', 'packages', 'stars', 'sponsoring', 'sponsors'`.
...
**Example 12**: `:link{id=FuTseYi/Azure class=github}` creates a :link{id=FuTseYi/Azure class=github} with `class=github` (or `.github`) to override the default style of a GitHub repository.

**Example 13**: `:link[Azure Themes]{id=https://github.com/FuTseYi/Azure img=https://github.githubassets.com/assets/mona-e50f14d05e4b.png}` fully customizes a link. :link[Azure Themes]{id=https://github.com/FuTseYi/Azure img=
https://azure-theme.vercel.app/favicon.ico}
