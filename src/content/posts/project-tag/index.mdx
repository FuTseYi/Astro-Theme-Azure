---
title: 'Azure: Project And Tag Page Config'
...
Example (`src/content/projects/Azure/index.mdx`):

```mdx title="projects/Azure/index.mdx"
---
name: 'Azure'
...
type: 'image'
icon: '../../../../public/projects/azure-theme.png'
