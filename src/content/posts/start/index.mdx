---
title: 'Azure: How to get started with this theme'
description: 'Quick start for the Azure theme: prerequisites, fork-or-template setup, and next steps.'
pubDate: 2025-08-15
author: 'FuTseYi'
...
- :link[Fork the repository]{id=https://github.com/FuTseYi/Astro-Theme-Azure/fork}
- :link[Use this template]{id=https://github.com/FuTseYi/Astro-Theme-Azure/generate} - In the future, content-free branches will be launched, which do not require deleting and replacing content.
