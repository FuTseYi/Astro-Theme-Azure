...
<div align="center">
<img src="./public/favicon.png" width="400" alt="Azure Logo" />

# Azure

![License](https://img.shields.io/github/license/FuTseYi/Astro-Theme-Azure?color=blue&style=flat-square)
...
[Demo](https://azure-theme.vercel.app/) · [Report Bug](https://github.com/FuTseYi/Astro-Theme-Azure/issues) · [Request Feature](https://github.com/FuTseYi/Astro-Theme-Azure/issues)
...
Azure is a comprehensive blogging theme crafted with **Astro**, **React**, and **TailwindCSS**. It is designed to provide developers with a clean, professional, and highly customizable platform to showcase their work, thoughts, and photography.

Unlike traditional themes, Azure emphasizes visual aesthetics without compromising on performance. It features fluid animations, a polished design system, and a robust set of built-in components to help you build your personal brand effectively.

![Cover image](./public/favicon.png)
...
Follow these simple steps to set up your Azure project locally.
...
1.  **Clone the repository**
    ...
    ```bash
    git clone https://github.com/FuTseYi/Astro-Theme-Azure.git
    cd Astro-Theme-Azure
    ```
...
Azure is designed to be easily configurable. The primary configuration file is located at `src/config.ts`.
...
![Star History Chart](https://api.star-history.com/svg?repos=FuTseYi/Astro-Theme-Azure&type=Date)

---

<p align="center">
made with 💗 by <a href="https://github.com/FuTseYi">FuTseYi</a> !
</p>